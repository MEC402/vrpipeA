...
Gimgtmpdir="/mnt/hgfs/bigdrive/tmp"
...
imgpref = sys.argv[2];
imgfileL = imgdir + "/" + sys.argv[2]+"_L.png";
imgfileR = imgdir + "/" + sys.argv[2]+"_R.png";
...
# convert the equirectangular png images into png files.
...
#test for success
eqleftpng = imgdir + "/" + imgpref + "_L.png";
eqrightpng = imgdir + "/" + imgpref + "_R.png";
